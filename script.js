...
const TRANSLATIONS = {
  zh: {
    ...
    sections: {
      ...
      liveInput: ["实时输入", "这是唯一的文字落点，用来观察 first char 和最终稳定文本。"],
    ...
    intro: {
      ...
      heroDesc: "它会递归读取音频测试集的子文件夹，驱动多个 app，用统一输入框接收文本，再把时序和结果写进 SQLite。",
      steps: [
  ...
  en: {
    ...
    sections: {
      ...
      liveInput: ["Live Input", "This is the only text sink used to observe first char and final stable text."],
